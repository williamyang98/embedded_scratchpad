...
class IconCpp:
    def __init__(self, icon):
        ...
        self.array_declaration = f"static const uint8_t {self.array_name}[{icon.total_bytes}] = {{{ array_body_cpp }}};"
...
class Palette:
    ...
    def get_cpp_string(self):
        ...
        return \
f"""static const uint16_t RGB565_COLOUR_PALETTE[{len(self.rgb565_palette)}] = {{{palette_body}}};
...
def main():
    ...
    parser.add_argument("--images", default="./scripts/icons", type=str)
    parser.add_argument("--output", default="./components/st7789/glyphs/icons.hpp", type=str)
